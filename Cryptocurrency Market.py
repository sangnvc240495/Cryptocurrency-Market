...
ax = cap10.plot(y='market_cap_perc', title=TOP_CAP_TITLE, kind='bar')
...
ax = cap10.plot(y='market_cap_perc', title=TOP_CAP_TITLE, kind='bar', color=COLORS, logy=True)
